...
def main():
    version_name = 'v1_10dBm_evaluation'
    ...
    for tt in range(t):
        ...
        model_name = 'TCOM_LOS_64beam_2CNN_0LSTM_256feature_16Tx_RK=8dB_baseline2_v1_10dBm_' + str(tt) + '_MODEL.pkl'
        model = torch.load(model_name)
        model.to(device)
        model.eval()

        eval_loader_name = '/usr/mk/TCOM/dataset/testing_10dBm'
