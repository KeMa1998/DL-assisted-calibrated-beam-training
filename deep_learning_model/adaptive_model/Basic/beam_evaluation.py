...
def eval(model, loader, device):
    ...
    while not done:
        ...
        if count==True:
            batch_num += 1
            out_tensor = model(channel2, device)
            loss = 0
...
def main():
    version_name = 'v1_k=7_evaluation'
    info = 'TCOM_LOS_64beam_2CNN_1LSTM_256feature_16Tx_RK=8dB_proposed3(basic)_MPC_' + version_name
    print(info)
    ...
    for tt in range(t):
        ...
        model_name = 'TCOM_LOS_64beam_2CNN_1LSTM_256feature_16Tx_RK=8dB_proposed3(basic)_MPC_k=7_' + str(tt) + '_MODEL.pkl'
